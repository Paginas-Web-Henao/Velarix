...
> **Documento maestro de negocio — versión 4.1**
>
...
Velarix no se presenta inicialmente como un SaaS de autoservicio para ejecutar
diagnósticos o valoraciones profesionales. La plataforma es, en la primera
etapa, una herramienta interna y un espacio controlado para recibir información,
ejecutar análisis y entregar resultados.

La única excepción pública de autoservicio es el **Estimador gratuito** descrito
en la sección 5.1. Este utiliza pocas variables, no recibe documentos, no produce
una valoración profesional y funciona exclusivamente como herramienta de entrada
comercial.
...
Mientras no exista un precio comercial validado, el descuento debe calcularse
contra un **precio provisional de piloto**. Ese precio se obtiene con la fórmula
interna mínima de la sección 6.3, debe quedar documentado y no debe presentarse
como tarifa definitiva de mercado.

Cuando exista un precio comercial validado, los descuentos se mostrarán contra
esa tarifa. En ningún caso el descuento debe convertir el trabajo en gratuito
sin una razón estratégica documentada.
...
## 17.1 Requisitos para cualquier servicio pagado que reciba documentos reales

`🚨 Bloqueante`

No se cobra ni se recibe información real para un Diagnóstico de preparación o
una Valoración profesional hasta cumplir:

- [ ] La seguridad mínima fue auditada.
- [ ] Existe separación de acceso por cliente.
- [ ] Existe NDA o cláusula de confidencialidad aplicable.
- [ ] Existe contrato o aceptación escrita de alcance.
- [ ] El cliente conoce el uso de proveedores externos.
- [ ] Existe política de retención y eliminación.
- [ ] Existe un procedimiento real para eliminar información.
- [ ] Los bugs que puedan alterar la salida del servicio están resueltos.
- [ ] El mismo input produce el mismo resultado dentro de la versión aprobada.
- [ ] Existen controles de moneda, unidades, signos y sumatorias.
- [ ] Existe revisión humana antes de entregar.
- [ ] El alcance puede ejecutarse con la capacidad disponible.
- [ ] Existe un protocolo ante información incompleta.
- [ ] El entregable diferencia hechos, supuestos, alertas y limitaciones.
- [ ] El precio fue calculado con horas y costos estimados de forma documentada.

## 17.2 Requisitos adicionales para cobrar una Valoración profesional

`🚨 Bloqueante`

Además de cumplir la sección 17.1:
...
- [ ] El informe define su uso permitido.
- [ ] El cliente entiende que no es auditoría ni garantía.
- [ ] Se puede defender el modelo ante un profesional competente.
- [ ] Los supuestos materiales están documentados y aprobados.
- [ ] Los casos dorados aplicables están aprobados.

## 17.3 Restricción del Diagnóstico de preparación

`✅ Confirmado`

El Diagnóstico puede tener un umbral metodológico menor que una Valoración
profesional porque no emite una opinión final de valor. Sin embargo, **no tiene
un umbral menor de seguridad, confidencialidad, reproducibilidad ni revisión
humana**.

Si entrega un rango indicativo, debe:

- señalar de forma visible que no es una valoración;
- explicar las limitaciones de información;
- impedir que el documento adopte apariencia o lenguaje de opinión profesional
  final;
- incluir únicamente cálculos cuya metodología haya sido probada;
- evitar conclusiones que requieran la revisión externa propia de la valoración,
  salvo que dicha revisión se haya realizado.
