  ...
  const renderLiquidez = () => {
    ...
    autoTable(doc, {
      ...
      body: [
        ...
        ["Días de cartera", `${result.kpis.daysReceivable} días`, "—"],
        ["Ciclo de caja", `${result.kpis.cashCycle} días`, result.kpis.cashCycle < 60 ? "✓ Eficiente" : "⚠ Extendido"],
      ],
      headStyles: { fillColor: DS.color.azulOscuro, textColor: DS.color.blanco, fontStyle: "bold", fontSize: 9 },
      alternateRowStyles: { fillColor: DS.color.grisFondo },
      bodyStyles: { fontSize: 9, textColor: DS.color.grisOscuro },
  ...
  const renderEficiencia = () => {
    ...
    autoTable(doc, {
      ...
      body: [
        ...
        ["Ciclo de caja", `${result.kpis.cashCycle} días`, "Cartera + Inventario − Proveedores"],
      ],
      headStyles: { fillColor: DS.color.azulOscuro, textColor: DS.color.blanco, fontStyle: "bold", fontSize: 9 },
      alternateRowStyles: { fillColor: DS.color.grisFondo },
      bodyStyles: { fontSize: 9, textColor: DS.color.grisOscuro },
