...
| Estudio manual de casos públicos — Biblioteca (A) (nuevo, `D-09`, activo) | Analizar empresas con información financiera pública para diseñar y validar el Expediente antes de implementarlo | **en curso** — Caso 01 (Tecnoglass) documentado y contrastado el 2026-08-10 (`docs/velarix/casos/01-tecnoglass/`); Caso 02 (empresa con economía distinta) pendiente, sin fecha | Ninguna — no requiere revisor, ni Expediente implementado, ni ningún bloque técnico |
