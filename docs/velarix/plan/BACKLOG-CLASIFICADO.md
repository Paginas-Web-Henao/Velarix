...
> y `Negocio_Velarix_v4.2.md`. Ningún `BL-XX` existente cambia de estado
> por esta actualización. Se agregan dos filas nuevas al final de esta
> tabla: `BL-33` (Expediente de Valoración V1, especificado no
> implementado) y `BL-34` (Biblioteca de casos de valoración, diferida).
...
| BL-34 | Biblioteca de casos de valoración (nuevo, diferido, `D-09`, 2026-08-10) | Usar empresas con información pública para probar el workflow del Expediente de Valoración, practicar normalización, identificar preguntas y comparar tratamientos — no para concluir que empresas del mismo sector se valoran igual | Negocio / Calidad | Baja (no bloquea nada hoy) | P3 | Diferido — depende de `BL-33` (MVP mínimo) | `BL-33` | `Negocio_Velarix_v4.2.md` §13.3.1 | Iniciativa registrada; sin ingestión automática implementada | Fundador |
